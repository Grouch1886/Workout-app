...
const Header = () => {
    ...
    <div className="ui secondary pointing menu" style={{"background-color": "#432386"}}>
        <Link to="/Workout-app" className="item" style={{"color": "whitesmoke", "font-size": "1.3rem", "font-weight": "600"}}>
                Woktout App
        </Link>

        <div className="right menu font-color">
            <Link to="/Workout-app" className="item " style={{"color": "whitesmoke", "font-size": "1.3rem", "font-weight": "400"}}>All Programs</Link> 
